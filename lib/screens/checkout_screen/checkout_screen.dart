...
import 'package:the_library/screens/checkout_screen/controllers/checkout_controller.dart';
                  ...
                  child: Column(
                    children: [
                                ...
                                () => controller.user.value == ""
                                    ...
                                    : Container(
                                        ...
                                        child: HorizontalThreeLayerWidget(
                                            isBook: false,
                                            image: controller
                                                    .userModel.value?.isMale
                                                    .toString() ??
                                                "",
                                            firstText:
                                                "${controller.userModel.value?.firstName ?? "User"} ${controller.userModel.value?.lastName ?? "name"}",
                                            ...
                                            if (userData != null) {
                                              ...
                                              ApplicationController.instance
                                                  .successSnackBar(
                                                      title: "QR Imported",
                                                      message:
                                                          "Reader: ${userData.firstName} ${userData.lastName}");
                                            } else {
                                              ApplicationController.instance
                                                  .errorSnackBar(
                                                      title:
                                                          "Unable to find user",
                                                      message:
                                                          "User ID must be wrong or user does not exist.");
                                            }
                                          },
                                          icon: Icons.search,
                                              ...
                                              ApplicationController.instance
                                                  .errorSnackBar(
                                                      title:
                                                          "Unable to add book",
                                                      message:
                                                          "Book is already in checkout list.");
                                            }
                                          },
                                          icon: Icons.add,
                                  ...
                                  children: [
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Obx(
                                          () => Text(
                                            "${controller.dateToReturn.value.month}/${controller.dateToReturn.value.day}/${controller.dateToReturn.value.year}",
                                            style: GoogleFonts.poppins(
                                                fontSize: 30,
                                                fontWeight: FontWeight.w600,
                                                color: mediumGray),
                      ...
                      Container(
                        ...
                        child: MaterialButtonIcon(
                          onTap: () {
                            controller.checkoutBooks(context);
                          },
